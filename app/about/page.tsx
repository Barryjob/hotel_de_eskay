        ...
        <section className="relative">
          <div className="relative h-[400px] w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
              ...
              <p className="mt-4 text-xl max-w-md mx-auto">Discover the story of Hotel De Eskay</p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed">
                  Founded in 2005, Hotel De Eskay has been providing exceptional hospitality to guests from around the
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
                  At Hotel De Eskay, our mission is to provide exceptional hospitality and create memorable
          ...
          <div className="w-[80%] mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[700px] text-muted-foreground md:text-xl">
                  Meet the dedicated professionals who make Hotel De Eskay a special place
                </p>
              </div>
            </div>
