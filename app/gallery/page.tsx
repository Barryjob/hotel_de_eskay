          ...
          <div className="w-[80%] mx-auto px-4 md:px-6">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/background-img2.jpg?height=250&width=400"
                  alt="Hotel Exterior"
                  fill
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/background-img1.jpg?height=250&width=400"
                  alt="Hotel Lobby"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/hotel1.jpg?height=250&width=400"
                  alt="Reception Area"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/hotel2.jpg?height=250&width=400"
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/hotel3.jpg?height=250&width=400"
                  alt="Hotel Bar"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/hotel4.jpg?height=250&width=400"
                  alt="Swimming Pool"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
        ...
        <section className="py-12 md:py-24 bg-muted/50">
          <div className="w-[80%] mx-auto px-4 md:px-6">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/one.jpg?height=250&width=400"
                  alt="Standard Room"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/two.jpg?height=250&width=400"
                  alt="Deluxe Room"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/three.jpg?height=250&width=400"
                  alt="Executive Suite"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/four.jpg?height=250&width=400"
                  alt="Family Suite"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/five.jpg?height=250&width=400"
                  alt="Bathroom"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/six.jpg?height=250&width=400"
                  alt="Room View"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
        ...
        <section className="py-12 md:py-24">
          <div className="w-[80%] mx-auto px-4 md:px-6">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/amenity1.jpg?height=250&width=400"
                  alt="Fitness Center"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/amenity2.jpg?height=250&width=400"
                  alt="Spa"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/amenity4.jpg?height=250&width=400"
                  alt="Conference Room"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/amenity5.jpg?height=250&width=400"
                  alt="Business Center"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/amenity3.jpg?height=250&width=400"
              ...
              <div className="relative h-[250px] rounded-lg overflow-hidden">
                <Image
                  src="/business.jpg?height=250&width=400"
                  alt="Hotel Garden"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                />
