        ...
        <section className="relative">
          <div className="relative h-[600px] w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4">
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Welcome to Hotel De Eskay & Suites</h1>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    ...
                    <span>1-5, Onafowokan Avenue, Opposite Total Filling station, Sagamu exppress junction, Sagamu.</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Phone className="h-5 w-5 text-primary" />
                    <span>0707890777</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Mail className="h-5 w-5 text-primary" />
                    <span>info@hoteldeeskay.com</span>
                  </li>
                </ul>
                <Button variant="outline" asChild>
