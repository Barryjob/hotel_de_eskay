      ...
      <div className="w-[80%] mx-auto flex flex-col gap-6 py-8 md:py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-lg font-medium">Hotel De Eskay</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-muted-foreground">1-5, Onafowokan Avenue, Opposite Total Filling station, Sagamu exppress junction, Sagamu.</span>
              </li>
              <li className="flex items-start gap-2">
                <Phone className="h-4 w-4 mt-0.5 text-muted-foreground" />
                <span className="text-muted-foreground">0707890777</span>
              </li>
              <li className="flex items-start gap-2">
                <Mail className="h-4 w-4 mt-0.5 text-muted-foreground" />
                <span className="text-muted-foreground">info@hoteldeeskay.com</span>
              </li>
            </ul>
          </div>
          <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row items-center justify-between border-t pt-6">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Hotel De Eskay. All rights reserved.
          </p>
